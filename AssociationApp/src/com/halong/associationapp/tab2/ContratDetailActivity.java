...
public class ContratDetailActivity extends BackActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tab2_contrat_detail_activity);
		tv_titleBar=(TextView)findViewById(R.id.tv_titleBar);
		Intent intent=getIntent();
		tv_titleBar.setText(intent.getExtras().getString("contratCat"));
		...
		mListView = (ListView) findViewById(R.id.listViewContract);
	...
	private void addData() {
		orderList = new ArrayList<HashMap<String, String>>();
			...
			hashMap.put("user_phone", "13926985432");
		...
		hashMap2.put("user_phone", "13926655432");
		...
		hashMap3.put("user_phone", "13926125432");
		...
		hashMap4.put("user_phone", "13926987832");
		...
		hashMap5.put("user_phone", "13926989332");
		...
		hashMap6.put("user_phone", "15426985432");
		...
		hashMap7.put("user_phone", "18626985432");
		...
		hashMap8.put("user_phone", "13686985432");
		...
		hashMap9.put("user_phone", "13926345432");
		...
		hashMap10.put("user_phone", "13924585432");
		...
		hashMap12.put("user_phone", "13346985432");
	...
	private void initViews() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ContratDetailActivity.this,
		...
		mAdapter = new SortAdapter(ContratDetailActivity.this, mSourceDateList);
	...
	private List<SortModel> filledData(List<HashMap<String, String>> orderList) {
		...
		for (int i = 0; i < orderList.size(); i++) {
			...
			sortModel.setUser_post(orderList.get(i).get("user_post").toString());
			sortModel.setUser_company(orderList.get(i).get("user_company").toString());
			sortModel.setUser_city(orderList.get(i).get("user_city").toString());
			sortModel.setUser_phone(orderList.get(i).get("user_phone").toString());
			sortModel.setUser_email(orderList.get(i).get("user_email").toString());
			sortModel.setUser_weibo(orderList.get(i).get("user_weibo").toString());
			sortModel.setUser_address(orderList.get(i).get("user_address").toString());
			...
			// 汉字转换成拼音
			String pinyin = mCharacterParser.getSelling(orderList.get(i).get("name").toString());
