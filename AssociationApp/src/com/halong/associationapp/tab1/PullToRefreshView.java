...
//	private String mLastUpdateTime;
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(R.string.pull_to_refresh_release);
		//	mHeaderUpdateTextView.setVisibility(View.VISIBLE);
			...
			mHeaderImageView.startAnimation(mFlipAnimation);
			// mHeaderImageView.
			mHeaderTextView.setText(R.string.pull_to_refresh_pull);
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView
					.setText(R.string.pull_to_refresh_footer_release);
	...
	private void headerRefreshing() {
		...
		mHeaderTextView.setText(R.string.pull_to_refresh_refreshing);
