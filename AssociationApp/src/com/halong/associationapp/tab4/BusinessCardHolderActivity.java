...
import com.halong.associationapp.tab2.CatContratActivity;
...
public class BusinessCardHolderActivity extends BackActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_buniness_card_holder);
		...
		toCatContrat = (Button)findViewById(R.id.toCatContrat);
		addData();
		initViews();
	}
	...
	private void initViews() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(BusinessCardHolderActivity.this,OnItemClickShowDialogActivity.class);
		...
		toCatContrat.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.toCatContrat:
			Intent intent = new Intent(BusinessCardHolderActivity.this, CatContratActivity.class);
			startActivity(intent);
			overridePendingTransition(R.anim.push_right_in,
					R.anim.push_left_out);
